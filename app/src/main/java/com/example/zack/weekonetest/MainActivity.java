...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreate: " + testPalindrome(armStrongNumber));
        Log.d(TAG, "onCreate: " + testPalindrome(anotherArmStrongNumber));
        Log.d(TAG, "onCreate: " + testPalindrome(notAnArmStrongNumber));
    ...
    public boolean testPalindrome (String string){
        String reverse = "";
    ...
    public int findLargestMode (ArrayList arrayList){
    ...
    public boolean testArmstrongNum (String num){
